...
public class ShapeDetectionUtilForm {
    ...
    private ShapeDetectionUtilForm() {
        // Empty by default
    }
    // endregion
    ...
    // region UI
    public static void createJFrame(JButton btnAtivarOlhoVirtual,JButton btnCapturar,JButton btnLimpar,
                                    JList lista_de_itens , final JPanel panel,
                                    JTextField desce,JTextField sobe,JButton btnPosicionar) {
...
// /*
        ...
        final JFrame window = new JFrame("BOT-360NEWS");
        ...
        groupLayout.setHorizontalGroup(
                groupLayout.createSequentialGroup()
                        .addComponent(lbVizualizador)

                        .addGroup(groupLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                .addComponent(panel,GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))

                        .addComponent(lista_de_itens,GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)

                        .addGroup(groupLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                .addComponent(sobe,GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))

                        .addGroup(groupLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                .addComponent(desce,GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))

                        .addComponent(btnCapturar,GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)

                        .addGroup(groupLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                .addComponent(btnPosicionar,GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)

                        )

                        .addGroup(groupLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                .addComponent(btnAtivarOlhoVirtual,GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        groupLayout.setVerticalGroup(
                groupLayout.createParallelGroup()
                        ...
                        .addGroup(groupLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                .addComponent(lbVizualizador,GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(panel,GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        )
                        .addComponent(lista_de_itens)
...
//        GridLayout grade = new GridLayout(2,3);
        ...
        window.add( new JLabel("VIZUALIZADOR "));
